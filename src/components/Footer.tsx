        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a
                href="https://www.facebook.com/skywardmedialtd"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-accent-red transition-colors"
                aria-label="Facebook"
              >
